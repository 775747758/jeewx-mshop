...
/** 
 * @author 作者 : 邓文杰
 * @version 创建时间：2015-10-21 下午4:14:23 
 * 类说明 
 */
public class WeiXinMshopService implements KeyServiceI {
	...
	public String excute(String content, TextMessageResp defaultMessage,
		...
		String oauth2Url=SnsAPI.connectOauth2Authorize(account.getAccountappid(), bundler.getString("domain")+ "/mshopWechatController.do?goShop", true, defaultMessage.getFromUserName());
