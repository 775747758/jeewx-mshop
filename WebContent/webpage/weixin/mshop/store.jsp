...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="storeController.do?saveStore">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
     ...
     ${user.userName }
		...
		<tr>
			<td align="right" width="10%" nowrap><label class="Validform_label"> 店铺名称: </label></td>
			<td class="value" width="10%"><input id="realName" class="inputxt" name="realName" value="${user.realName }" datatype="s2-10"> <span class="Validform_checktip">填写正确的店铺名称</span></td>
		</tr>
