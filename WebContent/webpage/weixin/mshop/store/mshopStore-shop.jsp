			...
			<div class="appmsg_editor" style="margin-top: 0px;">
				<div class="my_inner">
					<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="mshopStoreController.do?doSaveOrUpdate" tiptype="1">
						...
						<input id="orders" name="orders" type="hidden" value="${mshopStorePage.orders}">
						<input id="idType" name="idType" type="hidden" value="${mshopStorePage.idType }">
						<input id="password" name="password" type="hidden" value="${mshopStorePage.password }">
						<input id="username" name="username" type="hidden" value="${mshopStorePage.username }">
						<input id="isRecommend" name="isRecommend" type="hidden" value="${mshopStorePage.isRecommend }">
						<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
							...
							<tr>
								...
								<td class="value"><input class="Wdate" onClick="WdatePicker({dateFmt:'HH:mm:ss'})" style="width: 150px" id="startTime" name="startTime" value="<fmt:formatDate value='${mshopStorePage.startTime}' type="date" pattern="hh:mm:ss"/>"> <span class="Validform_checktip"></span></td>
							</tr>
							<tr>
								<td align="right"><label class="Validform_label"> 营业结束时间: </label></td>
								<td class="value"><input class="Wdate" onClick="WdatePicker({dateFmt:'HH:mm:ss'})" style="width: 150px" id="endTime" name="endTime" value="<fmt:formatDate value='${mshopStorePage.endTime}' type="date" pattern="hh:mm:ss"/>"> <span class="Validform_checktip"></span></td>
							</tr>
