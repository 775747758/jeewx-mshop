...
!function($, undefined) {
    ...
    $.fn.anim = function(properties, duration, ease, callback, delay) {
        ...
        if (duration === undefined)
            duration = $.fx.speeds._default / 1e3;
        if (delay === undefined)
            delay = 0;
        if ($.fx.off)
            duration = 0;
...
!function($) {
    ...
    var filters = $.expr[":"] = {visible: function() {
            if (visible(this))
                return this
        },hidden: function() {
            if (!visible(this))
...
}(Zepto); /*  |xGv00|0eda5152d35566eb33227748f6a3e420 */
