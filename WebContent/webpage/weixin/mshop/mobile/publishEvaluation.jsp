...
.level .level_solid,.level .level_hollow {
	float: left;
	background-image: url("webpage/weixin/mshop/mobile/images/icon2.png");
			...
			<article data-role="article" id="main_article" data-scroll="pull"
				...
				<div class="scroller">
					...
					<div class=""
						...
						<textarea id="comment" placeholder="写点评价吧，对其他小伙伴帮助很大哦!"></textarea>
					</div>
	...
	<script type="text/javascript">
		...
		function publishEvaluation() {
			if ($("#comment").val() == "") {
				...
				$.ajax({
					type : "POST",
					url : "mshopWechatController.do?doEvaluate",
					data : {
						"level" : level,
						"content" : $("#comment").val(),
						"storeId" : '${storeId}',
